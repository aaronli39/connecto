import { StyleSheet, Text, View, Dimensions, Image, Alert, Modal, Pressable } from "react-native";
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.modalText}>Navigate to your matches tab to say hello!</Text>
			<Pressable
